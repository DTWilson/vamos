...
(where $c_1 > 0$) such that we transform our variables from $z_i$ to 

$$
z_i' = c_i - \frac{c_i - z_i}{s}.
$$

This corresponds to taking the canonical hypothesis boundary intersecting the point $(0, c_2)$ and then shrinking it towards / expanding it away from the point $(c_1, c_2)$ to make it instead intersect the point $(b, c_x)$. Thus, within the trade-off region the hypothesis boundary is given by
...
vamos(null, alternative, sigma, alpha_nom, beta_nom=0.2, a=a, c_x=c, c_y=c, n_y=0)
v$n
