...
r <- NULL
for(n in ns){
  r <- rbind(r, ocs_value_cp(n, null, alternative, variance, cor_z, alpha_nom,  a, c_x = c, c_y = c, n_y = 0))
}

r2 <- NULL
for(n in ns){
  r2 <- rbind(r2, ocs_value_cp_wrong(n, null, alternative, cor_z, alpha_nom, variance, a, c_x = c, c_y = c, n_y = 0))
}

cbind(r[,2], r2[,2], r2[,2] - r[,2], r2[,2]/r[,2])
```
