...
vamos(null, alternative, sigma, alpha_nom=0.05, beta_nom=0.2, "value", 1000, .a=a, .c_x=c, .c_y=c, .n_y=0)

ocs_value_cp_wrong(147, null, alternative, cor_z, alpha_nom, variance, a, c_x = c, c_y = c, n_y = 0)
```
